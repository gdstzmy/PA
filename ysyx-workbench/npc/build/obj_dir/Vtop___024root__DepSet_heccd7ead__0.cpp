...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    if ((0U == (3U & (IData)(vlSelf->sw)))) {
        vlSelf->ledr = ((0xfffcU & (IData)(vlSelf->ledr)) 
                        | (3U & ((IData)(vlSelf->sw) 
                                 >> 2U)));
    } else if ((1U == (3U & (IData)(vlSelf->sw)))) {
        vlSelf->ledr = ((0xfffcU & (IData)(vlSelf->ledr)) 
                        | (3U & ((IData)(vlSelf->sw) 
                                 >> 4U)));
    } else if ((2U == (3U & (IData)(vlSelf->sw)))) {
        vlSelf->ledr = ((0xfffcU & (IData)(vlSelf->ledr)) 
                        | (3U & ((IData)(vlSelf->sw) 
                                 >> 6U)));
    } else if ((3U == (3U & (IData)(vlSelf->sw)))) {
        vlSelf->ledr = ((0xfffcU & (IData)(vlSelf->ledr)) 
                        | (3U & ((IData)(vlSelf->sw) 
                                 >> 8U)));
    }
...
#endif
                VL_FATAL_MT("/home/zmy/PA/ysyx-workbench/npc/vsrc/top.v", 1, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/zmy/PA/ysyx-workbench/npc/vsrc/top.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/zmy/PA/ysyx-workbench/npc/vsrc/top.v", 1, "", "NBA region did not converge.");
            }
